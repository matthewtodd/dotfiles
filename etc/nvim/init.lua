...
vim.keymap.set('n', '<leader>td', telescope.diagnostics)
vim.keymap.set('n', '<leader>tf', telescope.git_files)
...
vim.api.nvim_create_autocmd('LspAttach', {
  callback = function(ev)
    ...
    vim.keymap.set('n', '<leader>ts', telescope.lsp_document_symbols, opts)
    vim.keymap.set('n', '<leader>tS', telescope.lsp_dynamic_workspace_symbols, opts)
    vim.keymap.set('n', '<leader>cl', run_nearest_codelens, opts)
    vim.keymap.set('n', '<leader>cL', rerun_latest_codelens, opts)
