...
# removed from the file system, but the Git directory is kept
# around as it to make it possible to checkout past commits
# without requiring fetching from another repository.
#
